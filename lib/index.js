...
module.exports = function(moduleOptions = {}) {
  ...
  let outCss = '/*! bulma.io | MIT License | github.com/jgthms/bulma */'
  ...
  if (this.options.dev) {
    ...
    // or install sass-loader along in dependencies anyway, pass in sass
    // directly: variablePath + bulma/_all
